...
class Launcher:
    def __init__(self, master):
        ...
        self.start_button = Button(text="Starting the server", command=lambda: self.start())
        self.start_clients_button = Button(text="Starting the client", command=lambda: self.start_clients())
        self.stop_button = Button(text="Close all", command=lambda: self.stop())
