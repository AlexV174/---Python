...
def create_arguments_parser():
    parser = argparse.ArgumentParser(description='Poin port and address')
    parser.add_argument('-a', '--addr', default=DEFAULT_IP_ADDRESS, help='IP address')
    parser.add_argument('-p', '--port', type=int, default=DEFAULT_PORT, help='Port from 1024 to 65535)')
    parser.add_argument('-i', '--id', default=DEFAULT_CLIENT_ID, help='Client ID')
